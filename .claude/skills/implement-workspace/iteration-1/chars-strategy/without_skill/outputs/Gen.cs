...
public static class Gen
{
    ...
    private static readonly char[] PrintableAscii =
        Enumerable.Range(' ', '~' - ' ' + 1).Select(i => (char)i).ToArray();

    /// <summary>Returns a strategy that generates random printable ASCII characters (0x20–0x7E).</summary>
    public static Strategy<char> Chars() => SampledFrom(PrintableAscii);

    /// <summary>Returns a strategy that generates random characters from <paramref name="alphabet"/>.</summary>
