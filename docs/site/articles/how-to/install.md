...
using Conjecture.Xunit;  // [Property], [Example], [From<T>], [FromMethod], ...
```
...
```csharp
using Conjecture.Core;       // Generate, Strategy<T>, Assume, ConjectureSettings, ...
using Conjecture.Xunit.V3;  // [Property], [Example], [From<T>], [FromMethod], ...
```
...
```csharp
using Conjecture.Core;   // Generate, Strategy<T>, Assume, ConjectureSettings, ...
using Conjecture.NUnit;  // [Property], [Example], [From<T>], [FromMethod], ...
```
...
```csharp
using Conjecture.Core;    // Generate, Strategy<T>, Assume, ConjectureSettings, ...
using Conjecture.MSTest;  // [Property], [Example], [From<T>], [FromMethod], ...
```
...
using Conjecture.TestingPlatform;   // [Property], [Example], [From<T>], [FromMethod], ...
```
