...
public static class StrategySamplingExtensions
{
    ...
    {
        /// <summary>Returns a single value generated by <paramref name="strategy"/> using a fresh seed.</summary>
        public T Sample()
        {
        ...
        /// <summary>Returns a list of <paramref name="count"/> values generated by <paramref name="strategy"/> using a fresh seed.</summary>
        ...
        /// <summary>Returns an unbounded lazy sequence of values generated by <paramref name="strategy"/> using a fresh seed.</summary>
        ...
        /// <summary>Returns a lazy sequence of <paramref name="count"/> values generated by <paramref name="strategy"/> using a fresh seed.</summary>
    ...
    {
        /// <summary>Returns a single value generated by the seeded strategy.</summary>
        public T Sample() => SampleCore(seeded.Strategy, seeded.Seed);

        /// <summary>Returns a list of <paramref name="count"/> values generated by the seeded strategy.</summary>
        public IReadOnlyList<T> Sample(int count)
        {
            ArgumentOutOfRangeException.ThrowIfNegative(count);
        ...
        /// <summary>Returns an unbounded lazy sequence of values generated by the seeded strategy.</summary>
        public IEnumerable<T> Stream() => StreamCore(seeded.Strategy, seeded.Seed, count: null);

        /// <summary>Returns a lazy sequence of <paramref name="count"/> values generated by the seeded strategy.</summary>
        public IEnumerable<T> Stream(int count)
        {
            ArgumentOutOfRangeException.ThrowIfNegative(count);
