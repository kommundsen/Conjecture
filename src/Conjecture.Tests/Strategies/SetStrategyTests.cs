...
public class SetStrategyTests
{
    ...
    {
        var strategy = Gen.Sets(Gen.Integers<int>(0, 100));
    ...
    {
        var strategy = Gen.Sets(Gen.Integers<int>(0, 100), minSize: 3, maxSize: 5);
        for (var i = 0; i < 100; i++)
        {
    ...
    {
        var strategy = Gen.Sets(Gen.Integers<int>(0, 100));
        var set1 = strategy.Next(MakeData(99UL));
        var set2 = strategy.Next(MakeData(99UL));
    ...
    public void Sets_ExhaustedUniquenessRejectionBudget_MarksInvalid()
    {
        ...
        var data = MakeData();
        var strategy = Gen.Sets(Gen.Integers<int>(0, 2), minSize: 5, maxSize: 10);
