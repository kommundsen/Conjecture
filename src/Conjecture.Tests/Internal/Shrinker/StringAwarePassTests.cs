...
public class StringAwarePassTests
{
    ...
    [Fact]
    public async Task TryReduce_ReducesStringLength_AndDeletesTrailingCharAtomically()
    {
    ...
    [Fact]
    public async Task TryReduce_MultiCharDeletion_ReducesToEmptyStringOverIterations()
    {
        // 3-char string; interesting only when the string is empty (length == 0).
        IRNode[] nodes = [Len(3), Ch('x'), Ch('y'), Ch('z')];
    ...
    [Fact]
    public async Task TryReduce_StringCharNode_SimplifiesToA()
    {
        // 1-char string with 'z' (122). Predicate accepts when the char becomes 'a' (97).
        IRNode[] nodes = [Len(1), Ch('z')];
    ...
    [Fact]
    public async Task TryReduce_StringCharNode_SimplifiesToSpace_WhenANotInteresting()
    {
    ...
    [Fact]
    public async Task TryReduce_PreservesInterestingStatusAfterSimplification()
    {
    ...
    [Fact]
    public async Task TryReduce_IntegerNodesOnly_IsNoOp()
    {
        IRNode[] nodes = [IRNode.ForInteger(10, 0, 100), IRNode.ForInteger(20, 0, 100)];
    ...
    [Fact]
    public async Task TryReduce_EmptyString_IsNoOp()
    {
    ...
    [Fact]
    public async Task TryReduce_CharAlreadyA_NoCharSimplification()
    {
