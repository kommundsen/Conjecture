...
public class MatchingStrategyTests
{
    ...
    public void Matching_FixedShapePattern_EverySampleMatches()
    {
        ...
        IReadOnlyList<string> samples = DataGen.Sample(Strategy.Matching(pattern), 100, seed);
    ...
    public void Matching_IgnoreCase_ProducesMixedCase()
    {
        ...
        IReadOnlyList<string> samples = DataGen.Sample(Strategy.Matching(regex), 100, seed);
    ...
    public void Matching_UnicodeCategoryFull_AllowsNonAscii()
    {
        ...
        IReadOnlyList<string> samples = DataGen.Sample(Strategy.Matching(pattern, options), 200, seed);
    ...
    public void Matching_FailingProperty_ShrinksTowardShortestMatch()
    {
        ...
        IReadOnlyList<string> samples = DataGen.Sample(Strategy.Matching(pattern), 200, seed);
