...
{
    [Fact]
    public async Task Settings_AppearsInListResources()
    {
        ...
        Assert.Contains(result.Resources, r => r.Uri == "conjecture://api/settings");
    }

    [Fact]
    public async Task Settings_ReadReturnsNonEmptyMarkdown()
    {
        RequestContext<ReadResourceRequestParams> context =
            ResourceTestHelpers.MakeReadContext("conjecture://api/settings");
    ...
    [InlineData("MaxExamples")]
    [InlineData("[ConjectureSettings]")]
    public async Task Settings_ContentMentionsKeyTerms(string expectedTerm)
    {
        RequestContext<ReadResourceRequestParams> context =
            ResourceTestHelpers.MakeReadContext("conjecture://api/settings");
