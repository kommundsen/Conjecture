...
public sealed class XunitSample : IClassFixture<WebApplicationFactory<XunitSampleApp>>
{
    private readonly WebApplicationFactory<XunitSampleApp> factory;

    public XunitSample(WebApplicationFactory<XunitSampleApp> factory)
    {
