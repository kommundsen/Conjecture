...
/// <summary>Parses a JSON Schema document into a <see cref="JsonSchemaNode"/> tree.</summary>
[EditorBrowsable(EditorBrowsableState.Never)]
public static class JsonSchemaParser
{
    /// <summary>Parses <paramref name="root"/> into a <see cref="JsonSchemaNode"/> tree.</summary>
    public static JsonSchemaNode Parse(JsonElement root)
    {
